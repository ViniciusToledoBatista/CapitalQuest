...
<head>
    ...
    <title>Capital Quest - Novo Investimento</title>
...
<main class="container my-3">
    <div class="card card-form" tabindex="0">
        <div class="card-body">
            <h3 class="text-center mb-3">Registrar Novo Investimento</h3>
            ...
            <form action="investimento" method="post" class="needs-validation" novalidate>
                ...
                <label for="codigoTipoInvestimento" class="form-label">Tipo de Investimento:</label>
                <select id="codigoTipoInvestimento" name="codigoTipoInvestimento" required>
                    <option value="" disabled selected>Selecione o tipo</option>
                    <c:forEach var="tipo" items="${tiposInvestimento}">
                        <option value="${tipo.codigo}">${tipo.nome}</option>
                    </c:forEach>
                </select>
                <div class="invalid-feedback">Por favor, selecione o tipo de investimento.</div>

                <div class="d-grid gap-2" style="display: flex; flex-direction: column; gap: 0.75rem; margin-top: 1rem;">
                    <button type="submit" class="btn btn-success">Registrar Investimento</button>
                    <a href="investimento-lista" class="btn btn-outline-success" style="text-align: center;">Listar Investimentos</a>
                </div>
            </form>
        </div>
    </div>
